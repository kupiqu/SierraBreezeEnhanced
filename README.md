...
The version number in the file NEWS shows against which version of KWin the compilation should be done. *Compilation should not be done against other versions!*.
